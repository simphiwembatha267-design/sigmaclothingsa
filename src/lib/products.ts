...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Exclusive Tee',
    price: 370,
    image: exclusiveTopBlackBack.url,
    images: [exclusiveTopBlackBack.url, exclusiveTopBlack.url],
    category: 'Tops',
  ...
  },
  {
    ...
    name: 'Exclusive Tee',
    price: 370,
    image: exclusiveTopWhiteBack.url,
    images: [exclusiveTopWhiteBack.url, exclusiveTopWhite.url],
    category: 'Tops',
    description: 'Heavyweight 280gsm cotton jersey. Boxy oversized fit. Outlined Sigma loop logo at chest with arched "SIGMA EXCLUSIVE" graphic at back. Made in Portugal.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    color: 'White',
